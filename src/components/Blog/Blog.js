                        ...
                        blogData.map(data =>
                            <Col lg={4} md={6} sm={12}>
                                <Card className="blogCard">
                                    ...
                                    <Card.Body>
                                        <a href={data.url} target="_blank" rel="noreferrer"> <Card.Title className="blog-Topic-Title mt-1">{data.title}</Card.Title></a>
                                        ...
                                        <a className="readMore" href={data.url} target="_blank" rel="noreferrer">Read More</a>
                                    </Card.Body>
                                </Card>
                            </Col>
                        )
